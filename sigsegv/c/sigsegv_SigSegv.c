...
#include <unistd.h>
#include "jni.h"
#include "sigsegv_SigSegv.h"
#include "sigsegv_SigSegvNoHandler.h"
...
JNIEXPORT void JNICALL Java_sigsegv_SigSegv_callRiskyCode
...
JNIEXPORT void JNICALL Java_sigsegv_SigSegvNoHandler_callRiskyCodeNoHandler
  (JNIEnv *env, jclass obj) {
