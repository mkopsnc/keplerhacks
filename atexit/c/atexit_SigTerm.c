...
#include <unistd.h>
#include "jni.h"
#include "atexit_SigTerm.h"
#include "atexit_SigTermNoHandler.h"
...
JNIEXPORT void JNICALL Java_atexit_SigTerm_callExitCode
...
JNIEXPORT void JNICALL Java_atexit_SigTermNoHandler_callExitCodeNoHandler
  (JNIEnv *env, jclass obj) {
